...
/*    significant bits are all random.  Most of the macros have undocumented */
...
void exactinit(REAL maxx, REAL maxy, REAL maxz)
{
  ...
  /* Error bounds for orientation and in circle tests. */
...
/*  Sets h = e + b.  See the long version of my paper for details.           */
/*                                                                           */
/*  Maintains the non overlapping property.  If round-to-even is used (as     */
/*  with IEEE 754), maintains the strongly non overlapping and nonadjacent    */
/*  properties as well.  (That is, if e has one of these properties, so      */
/*  will h.)                                                                 */
/*                                                                           */
/*****************************************************************************/
...
/*  will be also.)  Does NOT maintain the non overlapping or nonadjacent      */
/*  properties.                                                              */
/*                                                                           */
/*****************************************************************************/
...
REAL orient3dd(const REAL* const __restrict__ pa, const REAL* const __restrict__ pb, const REAL* const __restrict__ pc, const REAL* const __restrict__ pd)
{
